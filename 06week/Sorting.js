...
const final = (acc, cur) => acc + cur;    
console.log(b.reduce(final));




// Find the index of the first value when added to it's index = 512 
const atxIdx = total.findIndex((value, index) => {
...
const idealTemp = weather.filter((identifier)=>{
  return identifier.min_temp === 15.915;
})
  .map((identifier)=>{
